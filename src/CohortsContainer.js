        ...
        return (
            <div>
                <Container style={{ marginTop: '6em', marginBottom: '20em' }}>
                    ...
                    <Search fluid placeholder={"Search by location"} size={"huge"} showNoResults={false} loading={this.props.cohortIsLoading} input={{ icon: 'search', iconPosition: 'left' }} onSearchChange={this.props.filterCohorts}/>
